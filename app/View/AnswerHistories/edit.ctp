...
<?php echo $this->Form->create('AnswerHistory'); ?>
	<fieldset>
		<legend><?php echo __('Edit Answer History'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('AnswerHistory.id')), array(), __('Are you sure you want to delete # %s?', $this->Form->value('AnswerHistory.id'))); ?></li>
