<div class="samples index">
	...
	<tr>
		...
		<td><?php echo h($sample['Sample']['number']); ?>&nbsp;</td>
		<td><?php echo h($sample['Sample']['item']); ?>&nbsp;</td>
		<td><?php echo h($sample['Sample']['strength']); ?>&nbsp;</td>
		<td class="actions">
			...
			<?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $sample['Sample']['id']), array(), __('Are you sure you want to delete # %s?', $sample['Sample']['id'])); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</tbody>
