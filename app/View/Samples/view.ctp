...
<h2><?php echo __('Sample'); ?></h2>
	<dl>
		...
		<dd>
			<?php echo h($sample['Sample']['number']); ?>
			&nbsp;
		</dd>
		<dt><?php echo __('Item'); ?></dt>
		<dd>
			<?php echo h($sample['Sample']['item']); ?>
			&nbsp;
		</dd>
		<dt><?php echo __('Strength'); ?></dt>
		<dd>
			<?php echo h($sample['Sample']['strength']); ?>
			&nbsp;
		</dd>
	</dl>
</div>
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete Sample'), array('action' => 'delete', $sample['Sample']['id']), array(), __('Are you sure you want to delete # %s?', $sample['Sample']['id'])); ?> </li>
